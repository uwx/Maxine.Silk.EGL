...
namespace Silk.NET.EGL.Extensions.EXT
{
    ...
    public enum EXT : int
    {
        ...
        [NativeName("Name", "EGL_CONFIG_SELECT_GROUP_EXT")]
        ConfigSelectGroupExt = 0x34C0,
        ...
        [NativeName("Name", "EGL_DRM_RENDER_NODE_FILE_EXT")]
        DrmRenderNodeFileExt = 0x3377,
        [NativeName("Name", "EGL_OPENWF_DEVICE_ID_EXT")]
        OpenwfDeviceIDExt = 0x3237,
        [NativeName("Name", "EGL_OPENWF_DEVICE_EXT")]
        OpenwfDeviceExt = 0x333D,
        [NativeName("Name", "EGL_DEVICE_UUID_EXT")]
        DeviceUuidExt = 0x335C,
        [NativeName("Name", "EGL_DRIVER_UUID_EXT")]
        DriverUuidExt = 0x335D,
        [NativeName("Name", "EGL_DRIVER_NAME_EXT")]
        DriverNameExt = 0x335E,
        [NativeName("Name", "EGL_RENDERER_EXT")]
        RendererExt = 0x335F,
        [NativeName("Name", "EGL_DEVICE_TYPE_EXT")]
        DeviceTypeExt = 0x3590,
        [NativeName("Name", "EGL_DEVICE_TYPE_OTHER_EXT")]
        DeviceTypeOtherExt = 0x3591,
        [NativeName("Name", "EGL_DEVICE_TYPE_INTEGRATED_GPU_EXT")]
        DeviceTypeIntegratedGpuExt = 0x3592,
        [NativeName("Name", "EGL_DEVICE_TYPE_DISCRETE_GPU_EXT")]
        DeviceTypeDiscreteGpuExt = 0x3593,
        [NativeName("Name", "EGL_DEVICE_TYPE_CPU_EXT")]
        DeviceTypeCpuExt = 0x3594,
        [NativeName("Name", "EGL_ALLOC_NEW_DISPLAY_EXT")]
        AllocNewDisplayExt = 0x3379,
        [NativeName("Name", "EGL_GL_COLORSPACE_BT2020_HLG_EXT")]
        GLColorspaceBT2020HlgExt = 0x3540,
        ...
        [NativeName("Name", "EGL_PRESENT_OPAQUE_EXT")]
        PresentOpaqueExt = 0x31DF,
        [NativeName("Name", "EGL_PROTECTED_CONTENT_EXT")]
        ProtectedContentExt = 0x32C0,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_EXT")]
        SurfaceCompressionExt = 0x34B0,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_PLANE1_EXT")]
        SurfaceCompressionPlane1Ext = 0x328E,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_PLANE2_EXT")]
        SurfaceCompressionPlane2Ext = 0x328F,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_NONE_EXT")]
        SurfaceCompressionFixedRateNoneExt = 0x34B1,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_DEFAULT_EXT")]
        SurfaceCompressionFixedRateDefaultExt = 0x34B2,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT")]
        SurfaceCompressionFixedRate1BpcExt = 0x34B4,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT")]
        SurfaceCompressionFixedRate2BpcExt = 0x34B5,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT")]
        SurfaceCompressionFixedRate3BpcExt = 0x34B6,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT")]
        SurfaceCompressionFixedRate4BpcExt = 0x34B7,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT")]
        SurfaceCompressionFixedRate5BpcExt = 0x34B8,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT")]
        SurfaceCompressionFixedRate6BpcExt = 0x34B9,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT")]
        SurfaceCompressionFixedRate7BpcExt = 0x34BA,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT")]
        SurfaceCompressionFixedRate8BpcExt = 0x34BB,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT")]
        SurfaceCompressionFixedRate9BpcExt = 0x34BC,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT")]
        SurfaceCompressionFixedRate10BpcExt = 0x34BD,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT")]
        SurfaceCompressionFixedRate11BpcExt = 0x34BE,
        [NativeName("Name", "EGL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT")]
        SurfaceCompressionFixedRate12BpcExt = 0x34BF,
