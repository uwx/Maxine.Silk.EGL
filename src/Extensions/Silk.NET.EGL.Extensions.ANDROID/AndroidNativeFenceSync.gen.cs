...
namespace Silk.NET.EGL.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidNativeFenceSync : NativeExtension<EGL>
    {
        ...
        [NativeApi(EntryPoint = "eglDupNativeFenceFDANDROID", Convention = CallingConvention.Winapi)]
        public partial int DupNativeFenceFD([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint dpy, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint sync);
