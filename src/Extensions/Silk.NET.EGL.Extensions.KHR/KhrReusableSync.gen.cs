...
namespace Silk.NET.EGL.Extensions.KHR
{
    ...
    public unsafe partial class KhrReusableSync : NativeExtension<EGL>
    {
        ...
        [NativeApi(EntryPoint = "eglSignalSyncKHR", Convention = CallingConvention.Winapi)]
        public partial bool SignalSync([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint dpy, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint sync, [Flow(Silk.NET.Core.Native.FlowDirection.In)] KHR mode);
